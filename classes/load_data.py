                ...
                with open(path, "r") as text_file:
                    for line in text_file:
                        ...
                        word = visual.TextStim(
                            ...
                            font="Arial",
                            text=text,
                            height=config["Text_stimulus_size"],
                ...
                if name[-3:] == "txt":
                    with open(path, "r") as text_file:
                        for line in text_file:
                            ...
                            data.append(
                                {"TYPE": "text", "NAME": folder + "_" + trigger_name, "STIM": word}
                            )
                    ...
                    data.append(
                        {"TYPE": "image", "NAME": folder + "_" + name.split(".")[0], "STIM": image}
                    )
                elif name[-3:] in possible_audio_format:
                    data.append(
                        {"TYPE": "sound", "NAME": folder + "_" + name.split(".")[0], "STIM": path}
                    )
                else:
                    raise Exception("Error while loading a file " + name)
            except:
